  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="relative z-10 grid min-h-screen grid-cols-1 items-center gap-10 px-5 py-8 sm:px-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(400px,500px)] lg:px-14 xl:px-24">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4" noValidate>
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    autoComplete="name"
                    className="h-12 rounded-xl border-border/60 bg-background/50 font-['Avenir_Next','Segoe_UI',sans-serif] text-foreground placeholder:text-muted-foreground focus-visible:border-primary/70 focus-visible:ring-primary/20"
                  ...
                  {errors.fullName ? (
                    <p
                      id="full-name-error"
                      className="font-['Avenir_Next','Segoe_UI',sans-serif] text-sm text-destructive"
                    >
                ...
                <div className="rounded-[1.35rem] border border-border/60 bg-background/35 p-4 sm:rounded-2xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-1 flex-col gap-3">
                      <Label
                        htmlFor="terms"
                        className="cursor-pointer font-['Avenir_Next','Segoe_UI',sans-serif] text-sm leading-6 text-card-foreground"
                      >
                ...
                {signupComplete ? (
                  <div
                    role="status"
                    aria-live="polite"
                    className="rounded-2xl border border-primary/25 bg-primary/10 px-4 py-3 font-['Avenir_Next','Segoe_UI',sans-serif] text-sm leading-6 text-card-foreground"
                  >
        ...
        <div className="mx-auto flex max-w-[500px] flex-col items-center gap-3 text-center font-['Avenir_Next','Segoe_UI',sans-serif] text-xs leading-relaxed text-muted-foreground lg:col-start-2 lg:justify-self-end">
