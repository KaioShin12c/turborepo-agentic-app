...
import { LoadingDots } from "../../features/auth/components/loading-dots";
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="relative z-10 grid min-h-screen grid-cols-1 items-center gap-10 px-5 py-8 sm:px-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(380px,480px)] lg:px-14 xl:px-24">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4" noValidate>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="remember" className="cursor-pointer font-sans text-sm text-muted-foreground">
                      Remember me
                    </Label>
                  </div>
                  <Link
                    to="/"
                    className="font-sans text-sm text-primary underline-offset-4 transition-colors hover:text-primary/80 hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
                ...
                {authError ? (
                  <Alert
                    variant="destructive"
                    className="rounded-2xl border-destructive/25 bg-destructive/10 font-sans text-sm leading-6"
                  >
        ...
        <p className="mx-auto max-w-[460px] text-center font-sans text-xs leading-relaxed text-muted-foreground lg:col-start-2 lg:justify-self-end">
